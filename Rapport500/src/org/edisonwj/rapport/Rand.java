...
/**
 * Rand defines random number generation methods used
 * throughout Rapport
 */

import java.util.*;

public class Rand implements RapportDefaults
{
...
/* Uniform random number generator - returns a number between a and b */
	...
	public double uniform (double a, double b)
	{
		if (b > a)
			...
			System.out.println("ERR possible a > b: in uniform(double, double):a= " + a + " b= " + b);
			return ( b + (a-b) * uniform() );
			//			return 0;
		}
	}
